...
(function () {
  ...
  inject();
  apply(preferred());
  // reflect signed-in state on <html> before first paint (members reveal, etc.)
  try { if (JSON.parse(localStorage.getItem('lw_auth') || '{}').signedIn) document.documentElement.classList.add('lw-signed-in'); } catch (e) {}
